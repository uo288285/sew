class Ciudad {
  ...
  /**
   * Inicializa los valores fijos de la ciudad
   */
  #rellenarValores() {
  ...
  /**
   * Realiza una petición AJAX para obtener
   * datos meteorológicos del día de la carrera
   */
  ...
  #procesarJSONCarrera(datosJSON) {
    ...
    // Buscar el índice correspondiente a las 15:00 (hora de inicio de carrera)
    ...
    // Extraer datos meteorológicos de la hora de la carrera
  ...
  /**
   * Realiza una petición AJAX para obtener
   * datos meteorológicos del periodo de entrenamientos
   */
  ...
  #procesarJSONEntrenos(datosJSON) {
    ...
    // Calcular medias diarias para cada métrica
  ...
  #mostrarMeteorologiaEntrenos() {
    ...
    this.#getMeteorologiaEntrenos().then((datosEntrenos) => {
      ...
      // Mostrar datos medios para cada día de entrenos
      for (const fecha in this.#datosEntrenos) {
