...
class Configuracion
{
    ...
    public function nuevoParticipante()
    {
        echo "<form method='post'>
                <h3>Introduce los datos del ususario</h3>
                <p>Género:
                ...
                <p>Pericia informática:  <input type='text' name='pericia'/></p>
                

                <p>Dispositivo: <input type='radio' name='dispositivo' value='ordenador'/>Ordenador
                <input type='radio' name='dispositivo' value='tableta'/>Tableta
                <input type='radio' name='dispositivo' value='telefono'/>Telefono</p>
    ...
    {
        //modificar para que sea incremental el identificador de usuario
        $this->crearConexion();
